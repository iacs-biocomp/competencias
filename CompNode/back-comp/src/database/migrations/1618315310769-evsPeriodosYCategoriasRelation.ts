...
export class evsPeriodosYCategoriasRelation1618315310769 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "cat_contr" ADD CONSTRAINT "UQ_b00ec271818c99549423117fe5c" UNIQUE ("catCompId")`,
		);
		await queryRunner.query(
			`ALTER TABLE "cat_contr" ADD CONSTRAINT "FK_b00ec271818c99549423117fe5c" FOREIGN KEY ("catCompId") REFERENCES "cat_comp"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
	}
