...
export class usrTrabajador1616752131213 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "trabajador" ADD CONSTRAINT "UQ_d76fc063217bb96e6f408050a4f" UNIQUE ("userUsername")`,
		);
		await queryRunner.query(
			`ALTER TABLE "trabajador" ADD CONSTRAINT "FK_d76fc063217bb96e6f408050a4f" FOREIGN KEY ("userUsername") REFERENCES "user"("username") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
